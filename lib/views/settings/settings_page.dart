  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.black12.withValues(alpha: 0.04), blurRadius: 6, offset: const Offset(0, 2))],
      ),
      child: LayoutBuilder(
              ...
              AnimatedPositioned(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(color: Colors.green.withValues(alpha: 0.35), blurRadius: 10, spreadRadius: 1),
                    ],
                  ),
                ),
              ),
