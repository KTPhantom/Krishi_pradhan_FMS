          ...
          builder: (context, controller) {
            ...
            return Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: Colors.black26.withValues(alpha: 0.06), blurRadius: 10)],
              ),
              child: Column(
                children: [
                  Padding(
                ...
                itemBuilder: (_, i) {
                  ...
                  return Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(color: Colors.black12.withValues(alpha: 0.05), blurRadius: 4, offset: const Offset(0, 1)),
                      ],
                    ),
